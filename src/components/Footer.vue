      ...
      <div class="row justify-content-between">
        ...
        <div class="col-3 col-xl-2 col-lg-3 col-md-3 col-sm-3">
          <div class="footer-widget">
            ...
            <ul class="list-unstyled">
              <router-link to="/product4"><li>Macbooks</li></router-link>
              <router-link to="/product"><li>iPhones</li></router-link>
              <router-link to="/products"><li>AirPods</li></router-link>
              <router-link to="/products"><li>iPads</li></router-link>
            </ul>
          </div>
        </div>
        ...
        >
          <div class="footer-widget">
            <h4>545 Woolwitch St,</h4>
            <h4>Waterloo, Ontario N3J5Y6</h4>
            <a href="mailto:info@g5shopping.com">info@g5shopping.com</a>
            <h6>+1 437 929 5262</h6>
          </div>
        </div>
      </div>
