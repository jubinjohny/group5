<template>
  <div class="">
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
          <img class="img-responsive" src="@/assets/G5logo.png" width="300" />
        </div>
      </div>
    </div>
    <div class="section-container">
      <div class="container">
        <div class="row">
          ...
          <div class="col-xs-15 col-md-15 col-md-offset-2">
            <p>
              G5 Shopping started in the year 2020 as a startup company and we have delivered around 2000 apple products to the customers in a cheaper price as of now. People prefer G5 Shopping as a reason of extended warrenty provided to people as part from us. We also provide phone cases, phone chargers and tempered glass for free during purchase and people can always approch us if they have damages with phone cases, phone charger and screen card. In such cases, we help to replace these items with 25% off compared to the actual price. Our protection plans for apple devices consist of a basic plan and a premium plan. The basic plan is for free and it covers the damages of the product for 3 years. The premium plan comes with a 5 year plan, it covers device damages for 5 years which costs 5% of the product price.
            </p>
            <p>
